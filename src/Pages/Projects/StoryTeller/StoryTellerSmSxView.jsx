...
/* Assets */
import DesignSystemBackgroundSmSx from './Images/DesignSystemBackground-SmSx.png';

function StoryTellerSmSx(props) {
    ...
    return (
        <div className='project-container'>
            ...
            <div 
                style={{
                    backgroundImage: `url(${DesignSystemBackgroundSmSx})`, 
...
export default StoryTellerSmSx;

StoryTellerSmSx.prototype = {
